<?php
  ...
  $_SESSION['document'] = array("id" => "books", "title" => "HBO-ICT Books", "author" => "Bastiaan Haaksema"); // Set document data
...
?>
  ...
  <p>Some of the books have become unavailable, my appologies.</p>
